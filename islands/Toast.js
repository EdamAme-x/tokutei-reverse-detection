...
import { useEffect as H, useState as j } from 'preact/hooks';
var Q = 20;
var S = new Map(),
  X = 1e3,
  $ = (e) => {
  ...
  I = (e = {}) => {
    ...
    let s = t.toasts.map((a) => {
      ...
      return {
        ...
        duration:
          a.duration ||
          ((r = e[a.type]) == null ? void 0 : r.duration) ||
...
import { useEffect as K, useCallback as L } from "preact/hooks";
var Z = (e, t) => {
...
import * as l from "preact/hooks";
import { styled as B, keyframes as z } from 'https://esm.sh/goober';
import * as y from "preact/hooks";
import { styled as C, keyframes as me } from 'https://esm.sh/goober';
import { styled as te, keyframes as k } from 'https://esm.sh/goober';
var oe = k`
from {
...
`;
import { styled as ae, keyframes as ie } from 'https://esm.sh/goober';
var ne = ie`
  from {
...
`;
import { styled as ce, keyframes as N } from 'https://esm.sh/goober';
var pe = N`
from {
  transform: scale(0) rotate(45deg);
	opacity: 0;
...
`,
  Ae = (e, t) => {
    ...
    return {
      animation: t
        ? `${z(a)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`
        : `${z(r)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`,
    };
  },
  F = l.memo(({ toast: e, position: t, style: o, children: s }) => {
    let a = e.height
        ? Ae(e.position || t || 'top-center', e.visible)
        : { opacity: 0 },
      r = l.createElement(M, { toast: e }),
      c = l.createElement(Se, { ...e.ariaProps }, T(e.message, e));
...
import { css as Pe, setup as Oe } from 'https://esm.sh/goober';
import * as f from "preact/hooks";
Oe(f.createElement);
var Ee = ({
    id: e,
    className: t,
      ...
      i.map((p) => {
        ...
        return f.createElement(
          ...
          p.type === 'custom'
            ...
            : a
            ? a(p)
            : f.createElement(F, { toast: p, position: g })
        );
      })
    );
  };
